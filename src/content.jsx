  ...
  en: {
    ...
    experiences: [
      {
        ...
        role: "Data Scientist",
        focus: "Predictive Maintenance — Rail",
        lede: <>Owning the <strong>RUL prediction pipeline</strong> for the axle fleet of <strong>12 TGV trainsets</strong>, combining anomaly detection and time-series modelling on multi-sensor data.</>,
        bullets: [
          <>Built <b>SI-ESSIEUX</b>, a full-stack axle-tracking application (React · Django · PostgreSQL) with real-time dashboards used by maintenance teams.</>,
          <>Designed and shipped the <b>data collection & preparation pipeline</b> from SI-ESSIEUX into the modelling layer.</>,
          <>Iterating on classical ML and neural baselines for Remaining-Useful-Life under operational constraints.</>,
        ],
        metrics: [
          { v: "12",  l: "TGV trainsets monitored" },
          { v: "RUL", l: "+ anomaly detection in production" },
        ],
        stack:  ["Python","PyTorch","Django","React","PostgreSQL","Time series"],
    ...
    projects: [
      ...
      },
      {
        ...
        body: "Crowdsourced platform building the first Moroccan‑Darija speech dataset for ASR research. Containerised stack — React frontend, Django API, PostgreSQL, MinIO object store — deployed on Kubernetes behind NGINX with GitLab CI rolling out updates on every merge.",
        infra: [
          { k: "Contributors", v: "465 voices · 1.6h captured" },
          { k: "Regions",      v: "Fez‑Meknès · Oriental · Tangier" },
          { k: "Stack",        v: "K8s · Django · PostgreSQL · MinIO" },
        ],
        tags: ["Kubernetes","GitLab CI","Django","React","PostgreSQL","MinIO","NGINX"],
      ...
      {
        num: "06",
        kind: "Real-time bot/human detection · ENSAM",
        title: <>WebBot<span className="it">Shield</span>.</>,
        body: "Distributed real-time pipeline — Nginx → Fluentd → Kafka → Spark Streaming → Elasticsearch / Kibana — with a weighted scoring engine on burstiness, HTTP error ratios and User-Agents.",
        tags: ["Kafka","Spark","Elasticsearch","Kibana"],
        ph: "kibana dashboard",
      },
      {
        num: "07",
  ...
  fr: {
    ...
    experiences: [
      {
        ...
        where: "Tanger, Maroc",
        role: "Data Scientist",
        focus: "Maintenance prédictive — Ferroviaire",
        lede: <>Pilote du <strong>pipeline de prédiction RUL</strong> sur le parc d'essieux des <strong>12 rames TGV</strong>, en combinant détection d'anomalies et modélisation de séries temporelles multi-capteurs.</>,
        bullets: [
          <>Conception de <b>SI-ESSIEUX</b>, application full-stack de suivi des essieux (React · Django · PostgreSQL) avec dashboards temps réel, utilisée par les équipes maintenance.</>,
          <>Pipeline de <b>collecte et préparation des données</b> depuis SI-ESSIEUX vers la couche de modélisation.</>,
          <>Itérations entre baselines ML classiques et réseaux de neurones pour la durée de vie restante en conditions opérationnelles.</>,
        ],
        metrics: [
          { v: "12",  l: "Rames TGV suivies" },
          { v: "RUL", l: "+ détection d'anomalies en prod" },
        ],
        stack:  ["Python","PyTorch","Django","React","PostgreSQL","Séries temp."],
        kStack: ["Python","PyTorch"],
      },
      {
        co: "AI-Inside",
    ...
    projects: [
      ...
      },
      {
        ...
        body: "Plateforme participative construisant le premier jeu de données vocales en darija marocain pour la recherche en reconnaissance de la parole. Stack containerisée — React, Django, PostgreSQL, MinIO — déployée sur Kubernetes derrière NGINX, GitLab CI livrant les mises à jour à chaque merge.",
        infra: [
          { k: "Contributeurs", v: "465 voix · 1,6h capturées" },
          { k: "Régions",       v: "Fès‑Meknès · Oriental · Tanger" },
          { k: "Stack",         v: "K8s · Django · PostgreSQL · MinIO" },
        ],
        tags: ["Kubernetes","GitLab CI","Django","React","PostgreSQL","MinIO","NGINX"],
      ...
      {
        num: "06",
        kind: "Détection bot/humain temps réel · ENSAM",
        title: <>WebBot<span className="it">Shield</span>.</>,
        body: "Pipeline distribué temps réel — Nginx → Fluentd → Kafka → Spark Streaming → Elasticsearch / Kibana — moteur de scoring pondéré (burstiness, ratio d'erreurs HTTP, User-Agents).",
        tags: ["Kafka","Spark","Elasticsearch","Kibana"],
        ph: "dashboard kibana",
      },
      {
